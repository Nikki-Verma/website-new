...
const Feature = () => {
  return (
    <div className="container">
        <h2>Go from Prototype to Production-Ready <br />RAG with Ease</h2>

      <div className="card_v2 px-8 pt-16 pb-12 mb-16 mt-20">
        <div className="flex items-center gap-24">
          ...
          <div className="w-3/5">
            ...
            <p>
              Experience a seamless workflow from data extraction and parsing to
              encoding, indexing, and integrating with vector databases. With
              built-in data loaders, search & filtering, retrieval, and
          ...
          <div className="h-full flex justify-between flex-col">
            <div>
              ...
              <p className="text-left">
                Ensure your generative systems rely solely on the facts and data
                you provide. Every generated response is traceable to its
                source, enhancing trust and credibility by allowing verification
                of factuality.
              </p>
            </div>
          ...
          <div className="h-full flex justify-between flex-col">
            <div>
              ...
              <p className="text-left">
                ...
                the perfect RAG strategy with multiple settings tailored to fit
                your specific needs.
              </p>
            </div>
            <div className="mx-auto text-center w-full mt-8">
      ...
      <div className="card_v2 px-8 pt-16 pb-12 mb-16">
        <div className="flex items-center gap-24 justify-between">
        <div className="w-1/2">
            <h2 className="heading_24 mb-4 text-left">Your Data is Secure</h2>
            <p>
            Keep complete control of your data with our privacy-first approach. Deploy your RAG systems on your own cloud, with our SOC 2 and ISO 27001 compliant platform
            </p>
          </div>
