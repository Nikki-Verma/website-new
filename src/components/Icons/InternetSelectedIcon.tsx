  ...
  >
    ...
    <g mask="url(#mask0_1655_21663)">
      ...
      <path
        ...
        stroke-miterlimit="10"
      />
      <path d="M12 0.703127V23.2969" stroke="black" stroke-miterlimit="10" />
      <path d="M0.703125 12H23.2969" stroke="black" stroke-miterlimit="10" />
      <path
...
const InternetSelectedIcon = ({ ...props }) => {
  return <Icon component={() => <InternetSelectedLogo />} {...props} />;
};

export default InternetSelectedIcon;
