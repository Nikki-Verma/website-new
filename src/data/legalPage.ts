...
import { AgilityIcon, ComplianceIcon, ConsultingAiWorkforce, ConsultingDataStructuring, ConsultingInsightGeneration, FasterIcon, LegalAiWorkforce, LegalDataAnalysis, LegalDocumentation, LegalHeroBanner, ResearchDataAnalysis, ResearchInsightGeneration, StreamlineIcon } from "@/util/svgImage";

export const banner = {
  title: "Legal, Consulting & Research",
  heading: "AI Workforce & Process Automation for Legal, Consulting, and Research",
  description:
...
export  const solution = [
  ...
  },
  {
    ...
    description: "Maintain high standards in legal documentation, research accuracy, and consulting analysis with automated compliance checks and enhanced data validation.",
    icon: ComplianceIcon,
  },
];
