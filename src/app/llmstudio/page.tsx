    ...
    <div className="hero_background">
      ...
      <div className="mt-120">
        ...
        <p className="font-18 text-white text-center mt-6 w-1/2 mx-auto">
          Simplify AI Integration and Accelerate Deployment—LLM Studio empowers
          developers and product teams to build secure, scalable, and reliable
          AI applications with unmatched observability.
        </p>
